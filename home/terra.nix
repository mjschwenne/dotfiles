...

{
  ...
  home.file.".config/hypr/hyprland.conf".text = ''
    ...
    ${builtins.concatStringsSep "\n" (builtins.genList (
        ...
        in ''
          bind = $mod, ${ws}, exec, ~/.config/hypr/scripts/try_swap_workspace ${toString (x + 1)}
  ...
  programs.fish = {
	  enable = true;
	  shellInit = ''alias vi="nvim"'';
  };

  home.file.".config/config.fish" = {
	  source = ./applications/fish.config;
  };
