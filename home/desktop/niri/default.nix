  ...
  xdg.configFile."niri/config.kdl".text =
    ...
    ''
      ...
      binds {
          ...
          Mod+Ctrl+M hotkey-overlay-title="Music" { spawn "/etc/profiles/per-user/mjs/bin/spotify"; }
          Mod+Ctrl+D hotkey-overlay-title="Discord" { spawn "${pkgs.vesktop}/bin/vesktop"; }

          // SYSTEM SETTINGS
          Mod+Alt+B hotkey-overlay-title="Bluetooth" { spawn "${pkgs.bzmenu}/bin/bzmenu" "-l" "fuzzel"; } // Bluetooth
          Mod+Alt+Shift+B hotkey-overlay-title=null { spawn "${pkgs.blueman}/bin/blueman"; }
          Mod+Alt+A hotkey-overlay-title="Volume Control" { spawn "${pkgs.pwmenu}/bin/pwmenu" "-l" "fuzzel"; } // Audio
          Mod+Alt+Shift+A hotkey-overlay-title=null { spawn "${pkgs.pavucontrol}/bin/pavucontrol"; }
          Mod+Alt+N { spawn "${pkgs.iwmenu}/bin/iwmenu" "-l" "fuzzel"; } // networking
          Mod+Alt+Shift+N hotkey-overlay-title=null { spawn "${pkgs.ghostty}/bin/ghostty" "-e" "${pkgs.networkmanager}/bin/nmtui"; }
          ...
          Mod+W { spawn "${window-switcher}/bin/window-switcher"; }
          ...
          Mod+Shift+U     { focus-workspace-down; }
